...
## Project Structure
    ...
    ├── testapiautocatalog_128405  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_128405`
...
2. Clone this repo and `cd testapiautocatalog_128405`
